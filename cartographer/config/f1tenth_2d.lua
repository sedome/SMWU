...
options = {
  ...
  odom_frame = "vesc/odom",
  provide_odom_frame = false, -- Set to false if an external node provides odom -> base_link transform
  use_odometry = true, -- Set to true to use odometry data for improved localization
  use_nav_sat = false,
  num_laser_scans = 1,
...
-- TUNE ADAPTIVE VOXEL FILTER FOR BETTER PERFORMANCE
...
-- TUNE CERES SCAN MATCHER FOR WEIGHTED SCAN-MATCHING
